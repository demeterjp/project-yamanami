...
>
  ...
  {selectedMode === "normal" && (
    <div className="flex gap-4 mt-4">
      <Link
        href="/katakana/easy/normal?questions=10"
      ...
      <Link
        href="/katakana/easy/normal?questions=20"
        className="bg-green-500 hover:bg-green-600 px-6 py-3 rounded-xl text-2xl font-bold"
      >
        20 Questions
      </Link>
...
>
  ...
  {selectedMode === "time" && (
    <div className="flex gap-4 mt-4">
      <button
        onClick={() => router.push("/katakana/easy/kanarush?time=15")}
      ...
      <button
        onClick={() => router.push("/katakana/easy/kanarush?time=30")}
        className="bg-yellow-500 hover:bg-yellow-600 px-6 py-3 rounded-xl text-2xl font-bold"
      >
        30s
      </button>
      ...
      <button
        onClick={() => router.push("/katakana/easy/kanarush?time=60")}
        className="bg-yellow-500 hover:bg-yellow-600 px-6 py-3 rounded-xl text-2xl font-bold"
      >
        60s
      </button>
      ...
      {/* RECALL */}
<div
  onClick={() => router.push("/katakana/easy/speed")}
  style={{
    border: "2px solid transparent",
  }}
  onMouseEnter={(e) => {
