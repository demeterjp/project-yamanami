...
export default function HiraganaPage() {
  ...
  return (
    <div className="min-h-screen text-white flex flex-col items-center p-10 gap-10">
      ...
      <div className="w-full max-w-2xl bg-zinc-900 rounded-3xl p-8 border border-green-500/30 shadow-[0_0_25px_rgba(34,197,94,0.3)]">
  <h1 className="text-7xl font-bold text-green-400 text-center">
    Hiragana Easy
  </h1>
</div>
...
>
  ...
  {selectedMode === "normal" && (
    <div className="flex gap-4 mt-4">
      <Link
        href="/hiragana/easy/normal?questions=10"
      ...
      <Link
        href="/hiragana/easy/normal?questions=20"
        className="bg-green-500 hover:bg-green-600 px-6 py-3 rounded-xl text-2xl font-bold"
      >
        20 Questions
      </Link>
...
>
  ...
  {selectedMode === "time" && (
    <div className="flex gap-4 mt-4">
      <button
        onClick={() => router.push("/hiragana/easy/kanarush?time=15")}
      ...
      <button
        onClick={() => router.push("/hiragana/easy/kanarush?time=30")}
        className="bg-yellow-500 hover:bg-yellow-600 px-6 py-3 rounded-xl text-2xl font-bold"
      >
        30s
      </button>
      ...
      <button
        onClick={() => router.push("/hiragana/easy/kanarush?time=60")}
        className="bg-yellow-500 hover:bg-yellow-600 px-6 py-3 rounded-xl text-2xl font-bold"
      >
        60s
      </button>
      ...
      {/* RECALL */}
<div
  onClick={() => router.push("/hiragana/easy/speed")}
  style={{
    border: "2px solid transparent",
  }}
  onMouseEnter={(e) => {
